...
using denizdikbiyik_CET322_FinalProject.Views;
...
namespace denizdikbiyik_CET322_FinalProject.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<KermesUser> signInManager, ILogger<LoginModel> logger)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if(Input.Email == "denizdikbiyik@gmail.com")
                    {
