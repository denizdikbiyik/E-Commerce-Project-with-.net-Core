...
namespace denizdikbiyik_CET322_FinalProject.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(7, ErrorMessage = "{0} en az {2} ve maksimum {1} karakter uzunluğunda olmalı.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("Şu kullanıcı: '{UserId}' iki faktörlü kimlik doğrulaması etkinleştirildi.", userId);
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("denizdikbiyik_CET322_FinalProject"),
